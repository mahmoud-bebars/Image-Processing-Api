...
Router.get('/resize', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, width, height, missdQuery, sizer;
    return __generator(this, function (_b) {
        switch (_b.label) {
                ...
                if (!height || ''
                    ...
                    : !width || ''
                        ...
                        : !name || ''
                            ...
                            : '')
                    return [2 /*return*/, res.status(400).send({ msg: "please add a ".concat(missdQuery) })
                        // handling the resizing function
                    ];
                return [4 /*yield*/, (0, imageSizer_1.default)(name, width, height)
            ...
            case 1:
                ...
                // handling any errors and send back error message
                if (!sizer.sized)
                    return [2 /*return*/, res.status(400).json({ msg: "\uD83D\uDEAB ".concat(sizer.err) })
                        // sending back the resized file to the browser
                    ];
                // sending back the resized file to the browser
                return [2 /*return*/, res.status(200).sendFile(sizer.file)];
        }
    });
}); });
